...
export default function Home() {
  ...
  return (
    <div className="bg-primary text-text-primary min-h-screen overflow-hidden font-sans">
      <section className="h-screen flex items-center justify-center relative">
        ...
        <div className="z-10 text-center">
          ...
          <motion.button
            ...
            className="bg-lime-400 text-black px-8 py-3 rounded-full font-bold shadow-lg hover:bg-lime-500 transition"
          >
            Купить товар
          </motion.button>
        </div>
      ...
      <div className="px-6 md:px-16 py-20">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-text-primary">Тренды сезона</h2>
      ...
      <div className="bg-secondary py-16 px-6 text-center">
        ...
        >
          ...
          <p className="text-text-muted text-sm">Основано в 2026</p>
        </motion.div>
      </div>
    </div>
  );
