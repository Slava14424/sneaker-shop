        ...
        <>
          ...
          >
            ...
            <div className="flex justify-between items-center p-5 border-b border-gray-800">
              ...
              <button onClick={onClose} className="text-2xl hover:text-lime-400 transition">
                ✕
              </button>
            </div>

            {/* Содержимое корзины (скролл) */}
            ...
            {/* Нижняя часть с расчётом и промокодом */}
            {cart.length > 0 && (
              <div className="border-t border-gray-800 p-5 space-y-4">
                ...
                {/* Кнопка оформления */}
                <button className="w-full bg-lime-400 text-black py-3 rounded-xl font-bold hover:bg-lime-500 transition">
                  Оформить заказ
                </button>
