...
export default function Checkout({ cart, total, clearCart }) {
  ...
  const validateField = (name, value) => {
    switch (name) {
      ...
      case "city":
        if (value.length < 2) return "Минимум 2 символа";
        if (value.length > 50) return "Максимум 50 символов";
        if (!/^[a-zA-Zа-яА-ЯёЁ\s\d-]+$/.test(value))
            ...
            <form onSubmit={handleSubmit} className="space-y-5 bg-[#0f0f0f] p-6 rounded-2xl border border-gray-800">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full bg-[#1a1a1a] border ${errors.name ? 'border-red-500' : 'border-gray-700'} rounded-lg px-4 py-2 focus:outline-none focus:border-lime-400`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full bg-[#1a1a1a] border ${errors.email ? 'border-red-500' : 'border-gray-700'} rounded-lg px-4 py-2 focus:outline-none focus:border-lime-400`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full bg-[#1a1a1a] border ${errors.phone ? 'border-red-500' : 'border-gray-700'} rounded-lg px-4 py-2 focus:outline-none focus:border-lime-400`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full bg-[#1a1a1a] border ${errors.address ? 'border-red-500' : 'border-gray-700'} rounded-lg px-4 py-2 focus:outline-none focus:border-lime-400`}
                />
                {errors.address && <p className="text-red-400 text-xs mt-1">{errors.address}</p>}
              </div>

              {/* Город (буквы, пробелы, дефисы, цифры) */}
              <div>
                ...
                <input
                  ...
                  value={formData.city}
                  onChange={handleChange}
                  placeholder="Москва, Санкт-Петербург, Королёв 1 и т.д."
                  className={`w-full bg-[#1a1a1a] border ${errors.city ? 'border-red-500' : 'border-gray-700'} rounded-lg px-4 py-2 focus:outline-none focus:border-lime-400`}
                />
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full bg-[#1a1a1a] border border-gray-700 rounded-lg px-4 py-2 focus:outline-none focus:border-lime-400"
                >
